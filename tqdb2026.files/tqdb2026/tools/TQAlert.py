    ...
    while(True):
        ...
        for rule in matchingWeekValRule:
            ...
            if QuoteSec>0:
                ...
                print("Q-->%s" % str(symbol,rule['RuleIdx'],rule['Rule'],curTimeS,lastTimeS,QuoteSec))
            ...
            if TickSec>0:
                ...
                print("T-->%s" % str(symbol,rule['RuleIdx'],rule['Rule'],curTimeS,lastTimeS,TickSec))
